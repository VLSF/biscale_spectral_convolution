...
if __name__ == "__main__":
    ...
    for equation in equations:
        ...
        for J_encoder_new in [4, 3, 2, 1, 0]:
            for J_decoder_new in [4, 3, 2, 1, 0]:
                ...
                if x_encoder_.shape[-1] < 32 or x_decoder_.shape[-1] < 32:
                    ...
                    test_rel_errors = jnp.mean(scan(compute_errors, [model, x_encoder_, x_decoder_, x_b, targets_encoder_, targets_decoder_], test_ind)[1])
        ...
        gt_codes = scan(encode_dataset, [model, x_encoder, x_b, targets_encoder], test_ind)[1]
        ...
        for J_encoder_new in [4, 3, 2, 1, 0]:
            ...
            if x_encoder_.shape[-1] < 32:
                ...
                test_ind = -(1 + jnp.arange(args["N_test"]))
                codes = scan(encode_dataset, [model, x_encoder_, x_b, targets_encoder_], test_ind)[1]
