...
from architectures import BiFNOk_DilResNet
...
if __name__ == "__main__":
    ...
    model = BiFNOk_DilResNet.BiFNOk(N_layers, N_features_a, N_features_b, N_modes, D, kernel_size, keys[1], s1=args['s1'], s2=0, s3=args['s3'])
