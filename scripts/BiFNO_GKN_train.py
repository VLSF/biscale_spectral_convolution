...
from architectures import BiFNO_GKN
...
if __name__ == "__main__":
    ...
    ind0, ind1 = BiFNO_GKN.get_indices(coordinates_a, coordinates_b, args['GKN_R'])
    ...
    model = BiFNO_GKN.BiFNO_GKN(N_layers, N_features_a, N_features_b, N_modes, D, args['GKN_proc'], args['GKN_layers'], keys[1], s1=args['s1'], s2=0, s3=args['s3'])
